...
\item
  \textbf{Empirical validation across 82 tasks} showing CostRouter achieves 2.7\% token cost reduction at matched accuracy compared to always-debate baseline, while improving cost-per-correct by 21.9\% and achieving 85.4\% accuracy versus oracle's 95.12\%.
\end{enumerate}
