...
Table~\ref{tab:main_results} answers the central question. CostRouter cuts token cost by 2.7\% relative to always-debate while gaining 15.9 percentage points of accuracy.
